            ...
            <div id="page-inner">
                ...
                <div class="row">
                      <div class="col-md-12">
                        ...
                        <h5>Change your password and update your personal information.</h5>
...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#menu2"><strong>Shipping</strong></a></li>
  <li><a data-toggle="tab" href="#menu1"><strong>Personal Info</strong></a></li>
  <li ><a data-toggle="tab" href="#home"> <strong>Password</strong></a></li>
</ul>
...
" >
        ...
        <div class="col-md-6" style="margin-top: 30px;">
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                       ...
                       <?php include "./php/update_info.php"; ?>
  ...
  <div id="menu2" class="tab-pane fade in active">
    <div class="row" >
        <div class="col-md-6" style="margin-top: 30px;">
              <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <i class="fa fa-plane fa-1x"></i><strong> Shipping Information </strong>
                  ...
                  <div class="panel-body">
                       ...
                       <?php include "./php/shipping_update.php"; ?>
    ...
    <script src="./js/update_shipping.js"></script>
