...
if (mysqli_num_rows($result) > 0) {
          ...
          <div class='modal-dialog'>
            ...
            <div class='modal-content'>
              <div class='modal-header'>
                ...
                <h4 class='modal-title'>Send Orders</h4>
              </div>
   ...
   $ent=$row["order_id"];
      ...
      <h5><strong>Total Paid:</strong> $".$row["total_paid"]."</h5><br>
                  <h5><strong>Tracking Number</strong></h5>
                   <form >
                    <div class='form-group'>
                        <input type='text' id='track_number".$row["order_id"]."' tabindex='1' class='form-control' >
                    </div>
            ...
            ?>
                <button type="button"  onclick="updatetrack('<?php echo $ent; ?>')" class="btn btn-success" >Send Order</button>
            <?php
                 echo "
                 </form>
              </div>
