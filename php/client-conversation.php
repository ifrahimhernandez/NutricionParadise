...
$sql2 = "SELECT messages.*,user.first_name,user.last_name FROM `messages` INNER JOIN consulting_log ON messages.consulting_log_id = consulting_log.consulting_log_id INNER JOIN user ON consulting_log.user_id = user.user_id where messages.consulting_log_id ='".$_GET["consulting_id"]."'  AND user.user_id = '".$_SESSION["user_id"]."' ORDER BY message_id DESC";
        ...
        if ($admin_or_not=="0") {
            ...
            echo "<li class='left clearfix'>
                    ...
                    <span class='chat-img pull-left'>
                            <img src='http://placehold.it/50/55C1E7/fff&text=AC' alt='User Avatar' class='img-circle'>
                    </span>
