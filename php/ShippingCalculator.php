...
<RatingServiceSelectionRequest xml:lang="en-US">  
	...
	function calculate_usps($code) {
		...
		$data = 'API=RateV4&XML=<RateV4Request USERID="'.$this->usps_user.'"> <Revision>2</Revision>';
		
		foreach($code as $x => $c) $data .= '<Package ID="'.$x.'"><Service>'.$c.'</Service><ZipOrigination>'.$this->from_zip.'</ZipOrigination><ZipDestination>'.$this->to_zip.'</ZipDestination><Pounds>'.$lbs.'</Pounds><Ounces>'.$ozs.'</Ounces><Container /><Size>REGULAR</Size> <Width>2</Width><Length>1</Length><Height>3</Height><Girth>10</Girth><Machinable>false</Machinable></Package>';
		$data .= '</RateV4Request>';
