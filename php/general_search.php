<?php 
		...
		$sql = "SELECT * FROM `product` where quantity > '0' and `disable_product`= '0' AND  product_name LIKE '%$search%'".$order ;
		...
		?>
				...
				<option value="search.php?search=<?php echo "$search"; ?>&amp;sort=product_id&amp;order=ASC" selected="selected">Default</option>
				<option value="search.php?search=<?php echo "$search"; ?>&amp;sort=product_name&amp;order=ASC" >Name (A - Z)</option>
				<option value="search.php?search=<?php echo "$search"; ?>&amp;sort=product_name&amp;order=DESC">Name (Z - A)</option>
				<option value="search.php?search=<?php echo "$search"; ?>&amp;sort=price&amp;order=ASC">Price (Low &gt; High)</option>
				<option value="search.php?search=<?php echo "$search"; ?>&amp;sort=price&amp;order=DESC">Price (High &gt; Low)</option>
		...
		$sql2 = "SELECT * FROM `product` where quantity > '0' and `disable_product`= '0' AND product_name LIKE '%$search%'".$order." ".$limit;
		...
		<br>
		<br>
		 <div style='margin-left:58px; margin-right:58px; padding:6px; background-color:#FFF; border:#999 1px solid;'> ".$paginationDisplay." </div> </div>
		";
		    } 
